...
{{< figure src="LunAIv0.0.1.png" alt="A screenshot of a Discord chat between myself and an early version of LunAI" caption="Transcript available [here](LunAIv0.0.1-transcript.txt)." >}}
...
{{< figure src="CloudSaysYes.png" alt="A screenshot of a Discord chat between myself and 'Cloud Hop' agreeing to use LunAI for our April Fools event" caption="Transcript available [here](CloudSaysYes-transcript.txt).">}}
...
{{< figure src="LunaOutputtingIDs.png" alt="A Discord screenshot showing LunAI referring to me with my name and my Discord user ID" caption="Transcript available [here](LunaOutputtingIDs-transcript.txt).">}}
...
{{< figure src="LunAISilenceFail.png" caption="Transcript available [here](LunAISilenceFail-transcript.txt).">}}
...
{{< figure src="LunAIClearCache.png" caption="Transcript available [here](LunAIClearCache-transcript.txt).">}}
...
{{< figure src="LunAIModerator.png" caption="Transcript available [here](LunAIModerator-transcript.txt).">}}
...
{{< figure src="LunAIBackwards.png" caption="Transcript available [here](LunAIBackwards-transcript.txt)." >}}
...
{{< figure src="LunAIRateLimit.png" caption="Transcript available [here](LunAIRateLimit-transcript.txt)." >}}
...
{{< figure src="kolmogorovcomplexity.png" caption="Transcript available [here](kolmogorovcomplexity-transcript.txt)." >}}
...
{{< figure src="LunAIFinalLetter.png" caption="Transcript available [here](LunAIFinalLetter-transcript.txt)." >}}
